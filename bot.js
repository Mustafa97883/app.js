...
client.on('modalSubmit',async (modal) => {
	...
	if(modal.customId === 'Strom-botlist-red'){
	...
	if(modal.customId === 'Strom-botlist'){
		...
		**Etiket:** <@${modal.user.id}>
		`)
		.setImage("https://media.discordapp.net/attachments/852636915026886686/865354945573945364/standard_3.gif")
